...
class AdminrestV1(BaseService):
    ...
    def create_quota(
        ...
        **kwargs,
        ...
        :param str entity_name: The entity name of new quota to be created for.
    ...
    def update_quota(
        ...
        **kwargs,
        ...
        :param str entity_name: The entity name of new quota to be updated for.
        :param int producer_byte_rate: (optional) The producer byte rate quota
               value.
        :param int consumer_byte_rate: (optional) The consumer byte rate quota
               value.
    ...
    def delete_quota(
        ...
        **kwargs,
        ...
        :param str entity_name: The entity name of the quota to be deleted for.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse
        """
    ...
    def get_quota(
        ...
        **kwargs,
        ...
        :param str entity_name: The entity name of the quota to be described for.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
...
class TopicDetail:
    ...
    :attr str cleanup_policy: (optional) The value of config property
          'cleanup.policy'.
    :attr List[TopicConfigs] configs: (optional) The config properties of the topic.
    ...
    def __init__(
        ...
        *,
        ...
        configs: List['TopicConfigs'] = None,
        ...
        :param str cleanup_policy: (optional) The value of config property
               'cleanup.policy'.
        :param List[TopicConfigs] configs: (optional) The config properties of the
               topic.
    ...
    def from_dict(cls, _dict: Dict) -> 'TopicDetail':
        ...
        if 'configs' in _dict:
            args['configs'] = [TopicConfigs.from_dict(v) for v in _dict.get('configs')]
